...
public:
    using CloseHandler = std::function<void(HttpSession*)>;
...
private:
    ...
    void on_proxy_response(Response response);
    void start_proxy(
    ...
    void on_write(bool keep_alive, const boost::system::error_code& error, std::size_t bytes_transferred);
    void close();
